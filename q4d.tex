% !TeX root = ./TMA01.tex
By the inclusion-exclusion principle,\marginnote{\hill p.76.} in which the sets $A$, $B$ to $F$ are the sets of codewords in $D$ that have the symbol "6" in the first, second, to the sixth coordinate positions respectively, we have
\begin{align*}
